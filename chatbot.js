...
(function () {
  ...
  var QA = [
    {
      keys: ['진료 시간', '영업 시간', '몇 시', '운영 시간', '언제 열', '언제 닫'],
      answer: '진료 시간은 평일 09:00~21:00, 토·일·공휴일 10:00~18:00이에요. 점심시간은 13:00~14:00이고, 응급 진료는 연중무휴 24시간 운영합니다. 방문 전 전화 주시면 대기 시간을 줄일 수 있어요!'
    },
    {
      keys: ['예약', '어떻게 해', '신청', '접수'],
      answer: '예약은 홈페이지 예약 페이지에서 온라인으로 하시거나, 전화(02-1234-5678)로도 가능해요. 응급 상황은 예약 없이 바로 전화 주세요! 온라인 예약 시 대기 시간이 줄어들어요.'
    },
    {
      keys: ['위치', '주소', '어디', '오시는', '찾아', '길'],
      answer: '서울특별시 강남구 행복로 24에 위치해 있어요. 2호선 행복역 3번 출구에서 도보 3분 거리예요. 주차도 가능하니 편하게 방문해 주세요!'
    },
    {
      keys: ['주차', '차 가져', '주차장'],
      answer: '네, 병원 내 주차장을 이용하실 수 있어요! 주차 공간이 넉넉하니 차량 방문도 편하게 하실 수 있어요.'
    },
    {
      keys: ['햄스터', '토끼', '기니피그', '고슴도치', '특수동물', '작은 동물', '소동물'],
      answer: '네, 햄스터·토끼·기니피그·고슴도치 등 특수동물 전문 진료를 합니다! 전용 진료실에서 특수동물 전문 수의사 박하늘 선생님이 진료해 드려요. 진료비는 3만원~이에요.'
    },
    {
      keys: ['응급', '긴급', '위급', '위험', '24시간', '밤에', '새벽'],
      answer: '응급 진료는 연중무휴 24시간 운영합니다! 응급 상황 시 02-1234-5678로 바로 전화 주세요. 호흡곤란, 경련, 심한 출혈 등 위험 증상은 즉시 연락해 주세요.'
    },
    {
      keys: ['비용', '가격', '얼마', '요금', '돈'],
      answer: '진료 비용은 내과 3만원~, 외과 수술 15만원~, 치과(스케일링·발치) 8만원~(마취 별도), 영상의학 5만원~, 예방접종·건강검진 2만원~, 특수동물 진료 3만원~이에요. 정확한 비용은 진료 후 안내해 드려요.'
    },
    {
      keys: ['의료진', '수의사', '선생님', '원장', '의사'],
      answer: '이수현 대표원장(내과 12년 경력), 이서연 진료원장(외과·마취), 박하늘 진료원장(특수동물 전문) 선생님이 진료하고 계세요. 모두 각 분야의 전문가들이에요!'
    },
    {
      keys: ['전화', '번호', '연락', '문의'],
      answer: '전화번호는 02-1234-5678이에요. 이메일은 care@happypet.kr로 문의하실 수도 있어요. 평일 09~21시, 주말 10~18시에 친절하게 안내해 드릴게요!'
    },
    {
      keys: ['토해', '구토', '게워', '먹은 거 올'],
      answer: '반려동물이 구토를 한다면 음식 문제, 소화기 질환, 이물질 섭취 등 다양한 원인이 있을 수 있어요. 하루 이상 지속되거나 혈액이 섞여 있다면 빠른 진료를 권장드려요. 정확한 진단은 수의사의 직접 진료가 필요해요.'
    },
    {
      keys: ['설사', '묽은 변', '혈변'],
      answer: '설사는 식이 변화, 감염, 기생충 등 다양한 원인이 있을 수 있어요. 하루 이상 지속되거나 혈변이 보인다면 빠른 진료가 필요해요. 탈수 예방을 위해 물을 충분히 마실 수 있게 해주세요.'
    },
    {
      keys: ['기침', '재채기', '호흡', '숨', '헐떡'],
      answer: '기침이나 호흡 곤란은 심각한 증상일 수 있어요. 특히 입을 벌리고 숨을 쉬거나 심하게 헐떡인다면 응급 상황일 수 있으니 즉시 02-1234-5678로 전화 주세요!'
    },
    {
      keys: ['안먹', '식욕', '밥을 안', '먹질 않'],
      answer: '식욕 저하는 스트레스, 질병, 치아 문제 등 다양한 원인이 있을 수 있어요. 하루 이상 먹지 않는다면 진료를 받아보시는 걸 권장드려요. 정확한 원인은 수의사 진료를 통해 확인할 수 있어요.'
    },
    {
      keys: ['예방접종', '백신', '접종', '주사'],
      answer: '생애주기별 예방접종 및 정기 건강검진을 진행하고 있어요. 강아지는 종합백신·광견병·코로나·켄넬코프 등, 고양이는 종합백신·광견병 접종이 필요해요. 비용은 2만원~이며 자세한 내용은 전화 주세요!'
    },
    {
      keys: ['스케일링', '치과', '이빨', '치아', '이가'],
      answer: '치과 진료(스케일링, 발치, 구강 검진)도 진행하고 있어요. 치석이 심하거나 구취가 심한 경우, 잇몸이 붉게 부어있는 경우 치과 진료가 필요해요. 비용은 8만원~(마취 별도)이에요.'
    },
    {
      keys: ['엑스레이', 'x-ray', '초음파', 'ct', '검사', '사진 찍'],
      answer: 'X-ray, 초음파, CT 등 영상의학 검사를 통해 정밀 진단이 가능해요. 내부 장기, 뼈, 종양 등을 빠르고 정확하게 확인할 수 있어요. 비용은 5만원~이에요.'
    },
    {
      keys: ['중성화', '수술', '중성'],
      answer: '중성화 수술은 건강과 행동 개선에 도움이 돼요. 외과 수술 비용은 15만원~이며, 안전한 마취 관리로 진행해요. 수술 전 검사가 필요할 수 있으니 사전에 전화 상담을 권장드려요.'
    },
    {
      keys: ['건강검진', '정기검진', '검진'],
      answer: '정기 건강검진은 질병을 조기에 발견하는 데 매우 중요해요. 기본 검진(2만원~)부터 정밀 검진까지 다양하게 준비되어 있어요. 1년에 한 번 이상 정기 검진을 권장드려요!'
    },
    {
      keys: ['긁', '피부', '가려워', '털', '탈모'],
      answer: '피부 가려움이나 탈모는 피부염, 알레르기, 기생충 등이 원인일 수 있어요. 내과 진료(3만원~)를 통해 원인을 파악하고 적절한 치료를 받으시길 권장드려요.'
    },
    {
      keys: ['눈', '충혈', '눈물', '분비물', '눈곱'],
      answer: '눈 충혈이나 분비물은 결막염, 각막 손상 등의 신호일 수 있어요. 눈을 자꾸 긁거나 눈물이 많이 난다면 내과 진료를 받아보시길 권장드려요. 빠른 치료가 중요해요!'
    },
    {
      keys: ['귀', '머리 흔들', '귀를 긁', '냄새'],
      answer: '귀를 자꾸 긁거나 머리를 흔든다면 외이염일 가능성이 있어요. 귀에서 냄새가 나거나 분비물이 보인다면 진료가 필요해요. 내과 진료(3만원~)를 통해 확인해 보세요.'
    },
    {
      keys: ['다리', '절름', '걷지', '못 걷', '관절'],
      answer: '다리를 절거나 걷기 힘들어한다면 관절 문제, 골절, 인대 손상 등이 원인일 수 있어요. 외과 수술이나 정형 치료가 필요할 수 있으니 빠른 진료를 권장드려요.'
    },
    {
      keys: ['안녕', '반가워', '처음', '안뇽'],
      answer: '안녕하세요! 행복펫 상담봇이에요 🐾 반려동물 진료, 예약, 건강 궁금증 무엇이든 편하게 물어보세요!'
    },
    {
      keys: ['고마워', '감사', '도움', '땡큐'],
      answer: '도움이 되었다니 다행이에요! 더 궁금한 점이 있으시면 언제든 물어보세요. 반려동물의 건강을 위해 행복펫이 항상 함께할게요 🐾'
    }
  ];
  ...
  #hpc-launch{ position:relative; width:68px; height:68px; border-radius:50%; display:grid; place-items:center;
    ...
    overflow:hidden; padding:0; animation: hpc-boing 2s ease-in-out infinite; transition:transform .25s cubic-bezier(.2,.7,.3,1); }
  #hpc-launch:hover{ animation: none; transform:translateY(-4px) scale(1.08); }
  #hpc-launch:active{ transform:scale(.94); }
  @keyframes hpc-boing{
    0%{transform:translateY(0) scale(1,1);} 10%{transform:translateY(0) scale(1.08,.92);}
    25%{transform:translateY(-18px) scale(.94,1.06);} 50%{transform:translateY(0) scale(1.06,.94);}
    60%{transform:translateY(-8px) scale(.97,1.03);} 75%{transform:translateY(0) scale(1.02,.98);}
    85%{transform:translateY(-3px) scale(1,1);} 100%{transform:translateY(0) scale(1,1);}
  }
  ...
  #hpc-launch::after{ content:""; position:absolute; right:-3px; bottom:-3px; width:18px; height:18px; border-radius:50%; background:var(--amber,#F4B33D); box-shadow:0 0 0 3px var(--bg,#F8F6F0); z-index:2; }
  ...
  .hpc-head{ display:flex; align-items:center; gap:12px; padding:16px 16px 14px; background:var(--primary,#0F6E5C); color:#fff; }
  ...
  .hpc-chip{ font-size:13px; font-weight:600; color:var(--primary-deep,#0A4A3E); background:var(--primary-tint,#E5F1EC); padding:8px 13px; border-radius:999px; transition:background .18s, transform .18s; box-shadow:inset 0 0 0 1px rgba(15,110,92,.12); }
  ...
  .hpc-quick a{ flex:1; display:inline-flex; align-items:center; justify-content:center; gap:6px; font-size:13px; font-weight:700; padding:9px 10px; border-radius:11px; transition:transform .18s, background .2s; }
  ...
  @media (max-width:520px){ #hpc-panel{ width:calc(100vw - 24px); height:calc(100vh - 100px); bottom:76px; } #hpc-root{ right:14px; bottom:14px; } }`;
  ...
  root.innerHTML =
    '<div id="hpc-panel" role="dialog" aria-label="행복펫 상담봇">' +
      '<div class="hpc-head">' +
        ...
        '<div class="acts">' +
          '<button class="hpc-reset" aria-label="대화 초기화">' + RESET + '</button>' +
          '<button class="hpc-close" aria-label="닫기">' + CLOSE + '</button>' +
        '</div>' +
      '</div>' +
      ...
      '<div class="hpc-foot">' +
        ...
        '</div>' +
        '<div class="hpc-input">' +
          '<textarea id="hpc-text" rows="1" placeholder="메시지를 입력하세요…"></textarea>' +
          '<button class="hpc-send" id="hpc-send">' + SEND + '</button>' +
        '</div>' +
  ...
  function addChips(list) {
    ...
    list.forEach(function (q) {
      ...
      c.textContent = q;
      c.addEventListener('click', function () { box.remove(); send(q); });
      box.appendChild(c);
    });
  ...
  function renderHistory() {
    bodyEl.innerHTML = '';
    if (!history.length) { addMsg('assistant', GREETING); addChips(SUGGESTIONS); }
  ...
  function openPanel() { root.classList.add('open'); markSeen(); setTimeout(function () { textEl.focus(); }, 280); scrollDown(); }
  ...
  root.querySelector('.hpc-reset').addEventListener('click', function () { history = []; save(); renderHistory(); });
